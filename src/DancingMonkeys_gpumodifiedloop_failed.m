...
NormalisedMonoData   = gzeros( size( Mono ) );
NormalisedSmoothData = gzeros( size( Mono ) );
...
GapWindow = gdouble(hamming( HalfGapWindowSize*2 ));
...
%     else
    ...
    IntervalFitness  = gzeros( [ (MaximumInterval - MinimumInterval + 1) 1 ] );
    IntervalGap      = gzeros( [ (MaximumInterval - MinimumInterval + 1) 1 ] );
    ...
    kSuperMax =  kMax * (NumBeats-1);
     GapsConfidence = gzeros(  NumBeats, 1 );
     GapsFiltered = gzeros( kMax * NumBeats, 1 );
     timeFirstloop = tic;
     gfor kk = 1:floor(kSuperMax/16)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        ...
        [ SortedGaps SortedIndex ] = sort( FullGaps );
          ct1 = mod(kSuperMax,kMax) +1;
            ...
            GapsFiltered(  (k-1) * (NumBeats -1)  + ct1 ) = Area;
          
           
      gend
      
      gfor kk = floor(kSuperMax/16) + 1:floor(kSuperMax/16 * 2)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
     ...
     gfor kk = floor(kSuperMax/16 * 2) + 1:floor(kSuperMax/16 * 3)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       ...
       gfor kk = floor(kSuperMax/16 * 3) + 1:floor(kSuperMax/16 * 4)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gfor kk = floor(kSuperMax/16 * 4) + 1:floor(kSuperMax/16 * 5)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
        ...
        gfor kk = floor(kSuperMax/16 * 5) + 1:floor(kSuperMax/16 * 6)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
        ...
        gfor kk = floor(kSuperMax/16 * 6) + 1:floor(kSuperMax/16 * 7)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       ...
       gfor kk = floor(kSuperMax/16 * 7) + 1:floor(kSuperMax/16 * 8)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       ...
       gfor kk = floor(kSuperMax/16 * 8) + 1:floor(kSuperMax/16 * 9)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
        ...
        gfor kk = floor(kSuperMax/16 * 9) + 1:floor(kSuperMax/16 * 10)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       ...
       gfor kk = floor(kSuperMax/16 * 10) + 1:floor(kSuperMax/16 * 11)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       ...
       gfor kk = floor(kSuperMax/16 * 11) + 1:floor(kSuperMax/16 * 12)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       ...
       gfor kk = floor(kSuperMax/16 * 12) + 1:floor(kSuperMax/16 * 13)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gfor kk = floor(kSuperMax/16 * 13) + 1:floor(kSuperMax/16 * 14)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
      gfor kk = floor(kSuperMax/16 * 14) + 1:floor(kSuperMax/16 * 15)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
      gfor kk = floor(kSuperMax/16 * 15) + 1:floor(kSuperMax/16 * 16)
        % gGapWindow = local(kk,GapWindow);
        %gBeatStrengths = local(kk,BeatStrengths);
        k = floor((kk-1) / (NumBeats-1) ) + 1;
        i = (k - 1) * IntervalFrequency + MinimumInterval;
      ...
      gend
       kSuperMax =  kMax * (NumBeats -1);
       displog( ImportantMsg, LFN, sprintf( '>>> timeFirstloop = %f', toc(timeFirstloop) ) );
      
       
       gfor kk = ((kSuperMax - kMax)* 0 / 16) + 1: ((kSuperMax - kMax) * 1 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
           ...
           ct1 = mod(kSuperMax,kMax) +1;
            ...
            % pointless. TODO?
            OffBeatValue = (GapsFiltered( (k-1) * (NumBeats -1)  + Pos ) + GapsFiltered( (k-1) * (NumBeats -1)  + Pos + 1 ) ) / 2;
            GapsConfidence(  ct1 ) = GapsFiltered( (k-1) * (NumBeats -1)  + ct1 ) + ( OffBeatValue * 0.5 );        
      ...
      gfor kk = ((kSuperMax - kMax)* 1 / 16) + 1: ((kSuperMax - kMax) * 2 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
    ...
    gfor kk = ((kSuperMax - kMax)* 2 / 16) + 1: ((kSuperMax - kMax) * 3 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 3 / 16) + 1: ((kSuperMax - kMax) * 4 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 4 / 16) + 1: ((kSuperMax - kMax) * 5 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 5 / 16) + 1: ((kSuperMax - kMax) * 6 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 6 / 16) + 1: ((kSuperMax - kMax) * 7 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 7 / 16) + 1: ((kSuperMax - kMax) * 8 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 8 / 16) + 1: ((kSuperMax - kMax) * 9 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gfor kk = ((kSuperMax - kMax)* 9 / 16) + 1: ((kSuperMax - kMax) * 10 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gend
      gfor kk = ((kSuperMax - kMax)* 10 / 16) + 1: ((kSuperMax - kMax) * 11 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gend
      gfor kk = ((kSuperMax - kMax)* 11 / 16) + 1: ((kSuperMax - kMax) * 12 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gend
      gfor kk = ((kSuperMax - kMax)* 12 / 16) + 1: ((kSuperMax - kMax) * 13 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gend
      gfor kk = ((kSuperMax - kMax)* 13 / 16) + 1: ((kSuperMax - kMax) * 14 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gend
      gfor kk = ((kSuperMax - kMax)* 14 / 16) + 1: ((kSuperMax - kMax) * 15 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
      ...
      gend
      gfor kk = ((kSuperMax - kMax)* 15 / 16) + 1: ((kSuperMax - kMax) * 16 / 16)
           k = floor( (kk-1) / (NumBeats -1)) +1;
           i = (k - 1) * IntervalFrequency + MinimumInterval;
           Gaps = mod( Beats, i );
           ExtraGaps = Gaps + i;
